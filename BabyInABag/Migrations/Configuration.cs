    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BabyInABag.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(BabyInABag.Models.ApplicationDbContext context)
        {
            ...
            context.ProductCategories.AddOrUpdate(
                ...
                new ProductCategory { Product_Category_Id = 1, Product_Category = "Blanket", Default_Image = "/images/blueb180237469.jpg", Default_Price = 50 , Active= true},
                new ProductCategory { Product_Category_Id = 2, Product_Category = "Boots", Default_Image = "/images/bubblesprite180347444.jpg", Default_Price = 40, Active = true },
                new ProductCategory { Product_Category_Id = 3, Product_Category = "Sleeping Bag", Default_Image = "/images/bluesky180530225.jpg", Default_Price = 60 , Active = true }
                );
        }
    }
}
